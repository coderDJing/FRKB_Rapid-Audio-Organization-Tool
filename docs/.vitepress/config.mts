...
export default defineConfig({
  ...
  locales: {
    root: {
      ...
      description: '内容感知去重与所见即所得的音频整理器。键盘优先的人机工学；真实文件层级一目了然。',
    },
    en: {
      label: 'English',
      lang: 'en-US',
      ...
      description: 'Content-aware dedup and WYSIWYG audio organizer. Keyboard-first ergonomics; true disk hierarchy at a glance.',
    }
  },
