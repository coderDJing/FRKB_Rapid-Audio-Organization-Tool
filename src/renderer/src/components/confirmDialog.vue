...
<template>
  <div class="dialog unselectable" style="position: absolute;font-size: 14px;">
    <div style="width: 300px;height: 180px;display: flex;flex-direction: column;justify-content: space-between;"
      class="inner">
      <div>
        ...
        <div style="padding-left: 20px;padding-right: 20px;">
          <div v-for="item of props.content" style="text-align: center;margin-top: 10px;"><span>{{ item }}</span></div>
        </div>
      </div>
