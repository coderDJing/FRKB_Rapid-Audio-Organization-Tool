...
/** 带进度回调的异步音频处理 */
export declare function calculateAudioHashesWithProgress(filePaths: Array<string>, callback?: (err: Error | null, arg: ProcessProgress) => void): Promise<Array<AudioFileResult>>
...
/** 计算整文件 SHA256（带进度） */
export declare function calculateFileHashesWithProgress(filePaths: Array<string>, callback?: (err: Error | null, arg: ProcessProgress) => void): Promise<Array<AudioFileResult>>
/**
 ...
 */
export declare function generateChromaprintFingerprint(filePath: string, maxLengthSeconds?: number | undefined | null): ChromaprintFingerprintResult
